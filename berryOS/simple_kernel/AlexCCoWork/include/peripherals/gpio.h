...
#define GPFSEL1         (PBASE+0x00200000)
...
#define GPSET0          (PBASE+0x0020001C) //GPIO pin output set (GPIO pin 0-31)
#define GPSET1          (PBASE+0x00200020) //GPIO pin output set (GPIOpin 32-53)

#define GPCLR0          (PBASE+0x00200028) //GPIO pin output clear (same as set)
#define GPCLR1          (PBASE+0x0020002C) //GPIO pin output clear (same as set)

#define GPLEV0          (PBASE+0x00200034) //GPIO pin level
...
#define GPREN0          (PBASE+0x0020004C) //GPIO rising-edge pin detect enable
#define GPREN1          (PBASE+0x00200050)

#define GPFEN0          (PBASE+0x00200058) //GPIO falling-edge pin detect enable
#define GPFEN1          (PBASE+0x0020005C)

#define GPHEN0          (PBASE+0x02000064) //GPIO pin high detect enable
#define GPHEN1          (PBASE+0x02000068)

#define GPLEN0          (PBASE+0x02000070) //GPIO pin low detect enable
#define GPLEN1          (PBASE+0x02000074)

#define GPAREN0         (PBASE+0x0200007C) //GPIO Pin Async. rising edge detect 
#define GPAREN1         (PBASE+0x02000080)

#define GPALEN0         (PBASE+0x02000088) //GPIO Pin Async.falling edge detect 
#define GPALEN1         (PBASE+0x0200008C)

#define GPPUD           (PBASE+0x00200094) //GPIO pin pull-up/down register
